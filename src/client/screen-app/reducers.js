...
export default function rootReducer(state, action) {
  ...
  const updateSelectedCandidate = () => {
    ...
    const combinedHistory = removeDuplicateEntries([
      ...newCandidateHistory,
  ...
  const sendMessage = () => {
    console.log('send message', action.value);
  ...
  const deliveredMessage = () => {
    ...
    console.log({ messageToUpdate, newHistory });
    return {
      ...state,
      selectedCandidate: { ...state.selectedCandidate, history: newHistory },
    };
  ...
  const newMessages = () => {
    ...
    const filteredHistory = removeDuplicateEntries([
      ...newHistory,
      ...action.value,
    ]);
    return {
